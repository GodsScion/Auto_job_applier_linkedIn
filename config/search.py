...
search_terms = ["React Native Developer", "React Developer", "Frontend Developer", "Full Stack Developer", "MERN Stack Developer"]
...
industry = ["Information Technology", "Software Development"]                      # (dynamic multiple select)
job_function = ["Development"]                  # (dynamic multiple select)
job_titles = ["React Native Developer", "React Developer", "Frontend Developer", "Full Stack Developer", "MERN Stack Developer"]                   # (dynamic multiple select)
...
bad_words = ["Java","Python","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
