...
search_terms = ["Entry Level Mechanical Engineer", "Engineering Consultant", "Entry Level Robotics Engineer", "Entry Level Financial Analyst","Entry Level Investment Banking Analyst"]
