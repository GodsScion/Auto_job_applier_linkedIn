...
# Your legal name
first_name = "Saidi Reddy"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Morthala"                # Your last name in quotes Eg: "Last", "Golla"
...
current_city = "Dubai"                  # Los Angeles, San Francisco, etc.
'''
